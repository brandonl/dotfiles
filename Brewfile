...
brew 'codeburn' # Codebase analysis CLI
...
brew 'hermes-agent' # Hermes AI agent CLI
...
brew 'peonping/tap/peon-ping' # Exercise reminder
...
cask 'expo-orbit' # Expo development client
...
cask 'font-monaspace' # Monaspace font
...
tap 'peonping/tap' # Peon Ping tap
